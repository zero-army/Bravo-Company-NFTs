            ...
            return
                abi.encodePacked(
                    '"attributes":[{"trait_type":"Rank","value":',
                                rank,
                                "},",
                                '{"display_type": "number","trait_type":"Mission Coins Earned || Units: ', 
                                coinUnits,
                                'Z3R0s","value":',
                                missionCoinBalance,
                                "},",
                    ...
                    Base64.encode(
                        bytes(
                            abi.encodePacked(
                                ...
                                bravoTitle,
                                tokenId.toString(),
                                '", "description": "Bravo Company collection - 200 Zero Army founders series NFTs [semi-fungible] with soulbound burnable $AIM0 - burn and earn Mission Coins in the Zero Army MetaSERVE! Visit zeroarmy.org/bravo for details.',
